...
Below are selected plots generated by the notebooks in the `examples/` folder. Each showcases a specific method or model implemented in `pyvar`.
...
- **Parametric Model – Normal VaR**  
  VaR, Expected Shortfall, and backtesting results computed under the parametric normal distribution assumption:  
  ![Parametric Normal Backtest](plots/parametric_normal_backtest.png)

- **Simulations**  
  Simulation-based VaR estimation for an options-heavy portfolio:  
...
- **Factor Models**  
  Estimation of portfolio volatility using factor risk models:  
  ![Factor Models](plots/factor_models.png)

- **Time-Varying Correlations**  
  Portfolio volatility estimation using models with time-varying return correlations:  
