...
- **Volatility Models – GJR-GARCH VaR**  
  Value-at-Risk (VaR), Expected Shortfall (ES), and backtesting results using the GJR-GARCH model with skewed Student-t innovations, applied to a subset of the data:  
...
- **Volatility Models - Comparison**  
  Portfolio volatility estimation using different volatility models:  
