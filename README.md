...
- **Simulations**  
  Simulation-based VaR estimation and profit-and-loss distributions for an options-heavy portfolio:  
...
- **Factor Models**  
  Estimation of portfolio volatility using multi-factor risk models:  
