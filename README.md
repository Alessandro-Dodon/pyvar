...
- **Volatility Modeling – GARCH**  
  Value-at-Risk (VaR), Expected Shortfall (ES), and backtesting results using the GJR-GARCH model on a subset of the data:  
...
- **Extreme Value Theory (EVT)**  
  Tail risk modeling using EVT on simulated profit and loss:  
  ![EVT](plots/evt.png)
