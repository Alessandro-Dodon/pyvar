...
- Use historical, parametric, and different simulation methods
...
├── examples/          ← multiple Jupyter notebooks illustrating practical use cases
├── plots/             ← generated figures summarizing results from the notebooks
...
Below are selected plots generated by the notebooks in the `examples/` folder. Each figure illustrates different aspects of financial risk modeling.
...
- **Parametric Model – Normal VaR**  
  Parametric Value-at-Risk using the normal distribution with backtesting overlay:  
  ![Parametric Normal Backtest](plots/parametric_normal_backtest.png)

- **Extreme Value Theory (EVT)**  
  Tail risk modeling using EVT to assess extreme losses:  
  ![EVT](plots/evt.png)

- **Simulations**  
  Monte Carlo simulation-based VaR estimation and distribution of outcomes:  
  ![Simulations](plots/simulations.png)

- **Factor Models**  
  VaR estimation using multi-factor risk models:  
  ![Factor Models](plots/factor_models.png)

- **Correlation Structure**  
  Heatmap of asset return correlations in the portfolio:  
