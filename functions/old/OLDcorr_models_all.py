...
#----------------------------------------------------------
def var_correlation_ma_parametric(x_matrix, confidence_level=0.99, window_size=20):
    """
...
#----------------------------------------------------------
def var_correlation_ewma_parametric(x_matrix, confidence_level=0.99, lambda_decay=0.94):
    """
...
#----------------------------------------------------------
def var_correlation_ma_empirical(x_matrix, confidence_level=0.99, window_size=20):
    """
...
#----------------------------------------------------------
def var_correlation_ewma_empirical(x_matrix, confidence_level=0.99, lambda_decay=0.94):
    """
